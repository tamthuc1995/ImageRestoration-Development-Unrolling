...
class GLR(nn.Module):
    ...
    def forward(self, patchs):
        ...
        features_patchs_GLR00 = features_patchs00
        ...
        system_residual00 = left_hand_sizeA -  self.apply_lightweight_transformer(output00, [graph_weightGLR00])
        output01          = output00 + self.alphaCGD[0, None, :, None, None, None] * system_residual00

        system_residual01 = left_hand_sizeA -  self.apply_lightweight_transformer(output01, [graph_weightGLR00])
        ...
        system_residual02 = left_hand_sizeA -  self.apply_lightweight_transformer(output02, [graph_weightGLR00])
        update02 = system_residual02 + self.betaCGD[2, None, :, None, None, None] * update01
        output02 = output02 + self.alphaCGD[2, None, :, None, None, None] * update02

        output_final = output02.view((batch_size, c_size, h_size, w_size))
