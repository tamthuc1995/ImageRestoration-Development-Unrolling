...
LOG_DIR = os.path.join(ROOT_PROJECT, "exploration/model_multiscale_mixture_GLR/result_v2/model_v20_sigma_25/logs/")
...
CHECKPOINT_DIR = os.path.join(ROOT_PROJECT, "exploration/model_multiscale_mixture_GLR/result_v2/model_v20_sigma_25/checkpoints/")
VERBOSE_RATE = 1000
