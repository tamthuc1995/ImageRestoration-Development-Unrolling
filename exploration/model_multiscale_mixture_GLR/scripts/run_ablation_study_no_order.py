...
import model_GLR_GTV_deep_v13_no_orders as model_structure


LOG_DIR = os.path.join(ROOT_PROJECT, "exploration/model_multiscale_mixture_GLR/result/model_sigma50_no_order/logs/")
...
CHECKPOINT_DIR = os.path.join(ROOT_PROJECT, "exploration/model_multiscale_mixture_GLR/result/model_sigma50_no_order/checkpoints/")
VERBOSE_RATE = 1000
