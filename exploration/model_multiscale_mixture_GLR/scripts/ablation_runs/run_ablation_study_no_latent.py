...
import model_GLR_GTV_deep_v13_no_latent as model_structure


LOG_DIR = os.path.join(ROOT_PROJECT, "exploration/model_multiscale_mixture_GLR/result/ablation/model_no_latent/logs/")
...
CHECKPOINT_DIR = os.path.join(ROOT_PROJECT, "exploration/model_multiscale_mixture_GLR/result/ablation/model_no_latent/checkpoints/")
VERBOSE_RATE = 1000
...
model = model_structure.MultiScaleGraphFilter( 
    n_channels_in=3, 
    n_channels_out=3, 
    ngraphs=32
).to(DEVICE)
