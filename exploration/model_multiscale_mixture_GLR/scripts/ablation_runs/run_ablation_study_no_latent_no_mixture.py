...
import model_GLR_GTV_deep_v13_no_latent_no_mixture as model_structure


LOG_DIR = os.path.join(ROOT_PROJECT, "exploration/model_multiscale_mixture_GLR/result/ablation/model_no_mixture/logs/")
...
CHECKPOINT_DIR = os.path.join(ROOT_PROJECT, "exploration/model_multiscale_mixture_GLR/result/ablation/model_no_mixture/checkpoints/")
VERBOSE_RATE = 1000
