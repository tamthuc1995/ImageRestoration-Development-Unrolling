...
LOG_DIR = os.path.join(ROOT_PROJECT, "exploration/model_multiscale_mixture_GLR/result/ablation/model_no_gtv/logs/")
...
CHECKPOINT_DIR = os.path.join(ROOT_PROJECT, "exploration/model_multiscale_mixture_GLR/result/ablation/model_no_gtv/checkpoints/")
VERBOSE_RATE = 1000
