...
LOG_DIR = os.path.join(ROOT_PROJECT, "exploration/model_multiscale_mixture_GLR/result/model_test25_sigma50/logs/")
...
CHECKPOINT_DIR = os.path.join(ROOT_PROJECT, "exploration/model_multiscale_mixture_GLR/result/model_test25_sigma50/checkpoints/")
VERBOSE_RATE = 1000
...
train_dataset01 = ImageSuperResolution(
    ...
    lambda_noise=[[1.0, 15.0, 25.0, 50.0], [0.05, 0.05, 0.1, 0.8]],
    use_data_aug=True,
...
lr_scheduler = MultiStepLR(
    optimizer,
    milestones=[100000, 200000, 350000, 500000, 575000, 650000], gamma=np.sqrt(0.5)
)
